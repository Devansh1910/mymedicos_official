    ...
    public class WeeklyFmgeQuizAdapterinsider extends RecyclerView.Adapter<WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder> {
        ...
        private void setOptionClickListeners(WeeklyFmgeQuizQuestionViewHolder holder) {
    ...
    //    }
        ...
        private void handleOptionClick(WeeklyFmgeQuizQuestionViewHolder holder, String option) {
            if (isOptionSelectionEnabled) {
                QuizFmgeinsider quizquestion = quizquestionsweekly.get(0);
                String selectedOption = quizquestion.getSelectedOption();
    ...
    //        }
        ...
        private void resetOptionStyle(WeeklyFmgeQuizQuestionViewHolder holder) {
