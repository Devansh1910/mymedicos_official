...
import com.medical.my_medicos.databinding.FragmentSlothBBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

public class SlothBFragment extends Fragment {

    private FragmentSlothBBinding binding;
    ...
    public static SlothBFragment newInstance() {
        SlothBFragment fragment = new SlothBFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSlothBBinding.inflate(inflater, container, false);
        ...
        if (args != null) {
            ...
            RecyclerView recyclerViewVideos = binding.slothsRecyclerviewB;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayoutFmge = binding.getRoot().findViewById(R.id.slothbswipe);
