...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
                        ...
                        if (snapshot.exists()) {
                            ...
                            if (coinsValue != null) {
                                ...
                                if (newCoinsValue >= 0) {
                                    ...
                                    Toast.makeText(FmgePrepPayement.this, "Welcome", Toast.LENGTH_SHORT).show();
                                } else {

                                    Toast.makeText(FmgePrepPayement.this, "Insufficient Credits", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
    ...
    private void showQuizInsiderActivity(String title, String title1) {
        Intent intent = new Intent(FmgePrepPayement.this, WeeklyQuizFMGEInsiderActivity.class);
