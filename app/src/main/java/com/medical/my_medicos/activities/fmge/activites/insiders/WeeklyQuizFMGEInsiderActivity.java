...
public class WeeklyQuizFMGEInsiderActivity extends AppCompatActivity implements WeeklyFmgeQuizAdapterinsider.OnOptionInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (str.equals(speciality) && str1.equals(title)) {
                        ...
                        for (Map<String, Object> entry : dataList) {
                            ...
                            id = document.getId();
                            QuizFmgeinsider quizQuestion;
                            if (imageUrl != null && !imageUrl.isEmpty()) {
                                quizQuestion = new QuizFmgeinsider(question, optionA, optionB, optionC, optionD, correctAnswer, imageUrl, description);
                            } else {
                                quizQuestion = new QuizFmgeinsider(question, optionA, optionB, optionC, optionD, correctAnswer, null, description);
                            }
        ...
        gotoQuestionButton.setOnClickListener(v -> {
            WeeklyQuizFMGEInsiderActivity.QuestionBottomSheetDialogFragment bottomSheetDialogFragment = WeeklyQuizFMGEInsiderActivity.QuestionBottomSheetDialogFragment.newInstance(selectedOptionsList, copy);
