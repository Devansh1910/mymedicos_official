...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful() && !task.getResult().isEmpty()) {
                            ...
                            Toast.makeText(FmgeExamPayment.this, "Not a valid coupon code", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void showInsufficientCreditsDialog() {
        ...
        intentCredits.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FmgeExamPayment.this, CreditsActivity.class); // Create an intent for the CreditsActivity
    ...
    private void showBottomSheet129() {
        View bottomSheetView = LayoutInflater.from(FmgeExamPayment.this).inflate(R.layout.bottom_sheet_up_250, null);
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(FmgeExamPayment.this);
        bottomSheetDialog.setContentView(bottomSheetView);
            ...
            usersRef.whereEqualTo("Phone Number", userId)
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                                ...
                                StringRequest request = new StringRequest(Request.Method.GET, url, response -> {
                                    try {
                                        ...
                                        if (requestBody.getString("status").equals("success")) {
                                            Toast.makeText(FmgeExamPayment.this, "Success order.", Toast.LENGTH_SHORT).show();
                                            String orderNumber = requestBody.getString("order_id");
                                            Log.e("Order ID check", orderNumber);
                                            new android.app.AlertDialog.Builder(FmgeExamPayment.this)
                                                    .setTitle("Order Successful")
                                                    .setCancelable(false)
                                                    .setMessage("Your order number is: " + orderNumber)
                                                    .setPositiveButton("Pay Now", (dialogInterface, i) -> {
                                                        Intent intent = new Intent(FmgeExamPayment.this, PaymentPublicationActivity.class);
                                                        intent.putExtra("orderCode", orderNumber);
                                                        startActivity(intent);
                                                    }).show();
                                        } else {
                                            Toast.makeText(FmgeExamPayment.this, "Failed order.", Toast.LENGTH_SHORT).show();
                                        }
                                    ...
                                    progressDialog.dismiss();
                                    Toast.makeText(FmgeExamPayment.this, "Volley Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(FmgeExamPayment.this, "Failed to retrieve user information", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            progressDialog.dismiss();
            Toast.makeText(FmgeExamPayment.this, "User not authenticated", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (coinsValue != null && coinsValue >= discount) {
                    ...
                    Toast.makeText(FmgeExamPayment.this, "Insufficient Coins", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(FmgeExamPayment.this, "Error fetching coins", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (coinsValue != null) {
                    ...
                    if (newCoinsValue >= 0) {
                        ...
                        Toast.makeText(FmgeExamPayment.this, "Welcome to the exam. Fee applied: " + newCoinsValue + " coins", Toast.LENGTH_SHORT).show();
                    } else {
