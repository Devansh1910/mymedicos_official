...
public class FmgeUpcomingAdapter extends RecyclerView.Adapter<FmgeUpcomingAdapter.FmgeUpcomingViewHolder> {
    ...
    @NonNull
    @Override
    public FmgeUpcomingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.quiz_upcoming_list_item, parent, false);
        return new FmgeUpcomingViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FmgeUpcomingViewHolder holder, int position) {
    ...
    public class FmgeUpcomingViewHolder extends RecyclerView.ViewHolder {
        ...
        public FmgeUpcomingViewHolder(@NonNull View itemView) {
            super(itemView);
