...
import com.example.my_medicos.activities.ug.uginsiderActivty;
import com.example.my_medicos.adapter.job.items.jobitem2;

import java.util.List;

public class MyAdapter8  extends RecyclerView.Adapter<com.example.my_medicos.adapter.ug.MyAdapter8.MyViewHolder8> {
    ...
    @NonNull
    @Override
    public com.example.my_medicos.adapter.ug.MyAdapter8.MyViewHolder8 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.job_design3, parent, false);
        return new com.example.my_medicos.adapter.ug.MyAdapter8.MyViewHolder8(v);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.my_medicos.adapter.ug.MyAdapter8.MyViewHolder8 holder, @SuppressLint("RecyclerView") int position) {
