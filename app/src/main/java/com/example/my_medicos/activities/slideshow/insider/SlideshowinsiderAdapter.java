...
public class SlideshowinsiderAdapter extends RecyclerView.Adapter<SlideshowinsiderAdapter.MyViewHolder2> {
    ...
    public MyViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.my_medicos.activities.slideshow.insider.SlideshowinsiderAdapter.MyViewHolder2(v);
    }
...
//    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.my_medicos.activities.slideshow.insider.SlideshowinsiderAdapter.MyViewHolder2 holder, @SuppressLint("RecyclerView") int position) {
